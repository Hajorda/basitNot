...
void _noteSerialize(
  ...
  writer.writeDateTime(offsets[2], object.lastEditDate);
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastEditDateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastEditDateGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastEditDateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastEditDateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> sortByLastEditDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastEditDate', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortByLastEditDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenByLastEditDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastEditDate', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByLastEditDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastEditDate', Sort.desc);
    });
  }
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  ...
  QueryBuilder<Note, Note, QDistinct> distinctByLastEditDate() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, DateTime, QQueryOperations> lastEditDateProperty() {
    return QueryBuilder.apply(this, (query) {
